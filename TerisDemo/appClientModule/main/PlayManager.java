...
public class PlayManager {
	...
	public PlayManager() {
		...
		left_x = (GamePanel.WIDTH/2) - (WIDTH/2); //640 - 180 = 460
	...
	private void checkDelete() {
		...
		while(x<right_x && y<bottom_y) {
			...
			if(x == right_x) {
				...
				// if the blockcount hits 12, that means the current y lines is all filled with blocks
				...
				if(blockCount == 12) {
					...
					for(int i = staticBlocks.size()-1; i> -1; i--) {
						// remove all the blocks int the current y line
